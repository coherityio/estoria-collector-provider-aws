...
@Slf4j
public class CloudWatchCompositeAlarmCollector extends AbstractAwsContextAwareCollector
{
    public static final String ENTITY_TYPE = "CloudWatchCompositeAlarm";


    public CloudWatchCompositeAlarmCollector()
    {
        super(awsCollectorInfoBuilder(ENTITY_TYPE, Set.of(), Set.of("monitoring", "cloudwatch", "alarm", "composite", "aws")).build());
    }
        ...
        CollectorRequestParams collectorRequestParams) throws CollectorException
    {
        ...
        try
        {
            ...
            DescribeAlarmsRequest.Builder requestBuilder = DescribeAlarmsRequest.builder().alarmTypes(AlarmType.COMPOSITE_ALARM);
            ...
            List<CompositeAlarm> alarms = response.compositeAlarms();
            ...
            if (alarms != null)
            {
                for (CompositeAlarm alarm : alarms)
                {
                    if (alarm == null)
                    {
                        continue;
                    ...
                    attributes.put("alarmRule", alarm.alarmRule());
                    ...
                    attributes.put("actionsSuppressedBy", alarm.actionsSuppressedByAsString());
                    attributes.put("actionsSuppressor", alarm.actionsSuppressor());
                    attributes.put("actionsSuppressorWaitPeriod", alarm.actionsSuppressorWaitPeriod());
                    attributes.put("actionsSuppressorExtensionPeriod", alarm.actionsSuppressorExtensionPeriod());
        ...
        {
            log.error("CloudWatchCompositeAlarmCollector unexpected error", e);
            throw new CollectorException("Unexpected error collecting CloudWatch composite alarms", e);
        }
    }
}