 ...
 */
@Slf4j
public class Ec2ImageCollector extends AbstractAwsContextAwareCollector
{
    ...
    {
        super(awsCollectorInfoBuilder(ENTITY_TYPE, Set.of(), Set.of("compute", "ec2", "ami", "image", "aws")).build());
