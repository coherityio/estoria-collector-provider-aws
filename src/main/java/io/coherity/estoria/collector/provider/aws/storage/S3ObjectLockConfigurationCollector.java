 ...
 */
@Slf4j
public class S3ObjectLockConfigurationCollector extends AbstractAwsContextAwareCollector
{
    ...
    {
        super(awsCollectorInfoBuilder(ENTITY_TYPE, Set.of("S3Bucket"), Set.of("storage", "s3", "object-lock", "aws")).build());
        ...
        try
        {
            ...
            if (buckets != null)
            {
                for (Bucket bucket : buckets)
                {
                    ...
                    try
                    {
                        lockResponse = s3Client.getObjectLockConfiguration(
