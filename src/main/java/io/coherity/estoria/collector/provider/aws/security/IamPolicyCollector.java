 ...
 */
@Slf4j
public class IamPolicyCollector extends AbstractAwsContextAwareCollector
{
    ...
    {
        super(awsCollectorInfoBuilder(ENTITY_TYPE, Set.of(), Set.of("security", "iam", "policy", "aws")).build());
