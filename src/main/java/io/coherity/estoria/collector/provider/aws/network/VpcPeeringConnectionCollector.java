 ...
 */
@Slf4j
public class VpcPeeringConnectionCollector implements Collector
{
	...
	{
		log.debug("VpcPeeringConnectionCollector.collect called with request: {}", collectorRequestParams);
