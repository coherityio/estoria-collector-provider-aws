 ...
 */
@Slf4j
public class Ec2PlacementGroupCollector extends AbstractAwsContextAwareCollector
{
    ...
    {
        super(awsCollectorInfoBuilder(ENTITY_TYPE, Set.of(), Set.of("compute", "ec2", "placement-group", "aws")).build());
