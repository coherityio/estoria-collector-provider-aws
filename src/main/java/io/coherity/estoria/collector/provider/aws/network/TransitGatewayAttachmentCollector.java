 ...
 */
@Slf4j
public class TransitGatewayAttachmentCollector implements Collector
{
	...
	private final CollectorInfo collectorInfo =
			CollectorInfo
				...
				.requiredEntityTypes(Set.of("TransitGateway"))
	...
	{
		log.debug("TransitGatewayAttachmentCollector.getCollectorInfo called - returning {}", this.collectorInfo);
	...
	{
		log.debug("TransitGatewayAttachmentCollector.collect called with request: {}", collectorRequestParams);
