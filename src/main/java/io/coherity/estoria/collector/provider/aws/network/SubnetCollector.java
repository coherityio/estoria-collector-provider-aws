 ...
 */
@Slf4j
public class SubnetCollector implements Collector
{
	...
	{
		log.debug("SubnetCollector.getCollectorInfo called - returning {}", this.collectorInfo);
	...
	{
		log.debug("SubnetCollector.collect called with request: {}", collectorRequestParams);
